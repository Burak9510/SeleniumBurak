...
public class Homework2_1 extends CommonMethods{
...
//		Take a screenshot
		...
		//click to Employee List
		click(driver.findElement(By.id("menu_pim_viewEmployeeList")));
		
		//send to new employee data
		sendText(driver.findElement(By.id("first-name-box")), "Megan");
		sendText(driver.findElement(By.id("last-name-box")), "Fox");
		...
		//it includes waitForClickability
		...
		waitForVisibility(driver.findElement(By.id("pimPersonalDetailsForm"))).click();
		...
		try {
			FileUtils.copyFile(sourceFile, new File("screenshots/Lesson13/Homework2_1.png"));
		} catch (IOException e) {
