...
public class CommonMethods extends BaseClass {
	...
	/**
	 * This methods first clear the textbox and sends some text
	 * 
	 * @param element
	 * @param text
	 */
	...
	/**
	 * This method first checks if radio/checkbox is enabled and then 
	 * clicks on the element that has the value that we are looking for 
	 * 
	 * @param elementList
	 * @param value
	 */
